...
<div class="wrap">
  <div id="icon-edit" class="icon32 icon32-posts-post"></div>
	...
	<div class="tablenav bottom">
		...
		<a href="<?php echo WP_PHOTO_50_ADMIN_URL; ?>&amp;ac=set"><input class="button action" type="button" value="<?php _e('Setting', 'wp-photo-text-slider-50'); ?>" /></a>
		...
		<a target="_blank" href="<?php echo WP_PHOTO_50_FAV; ?>"><input class="button button-primary" type="button" value="<?php _e('Short Code', 'wp-photo-text-slider-50'); ?>" /></a>
	</div>
	</div>
</div>